...
export class GridListItem {
    ...
    public copyForBreakpoint(breakpoint? : any) {
        const itemCopy = new GridListItem();
    ...
    public getValueX(breakpoint?: any) {
        const item = this.getItem();

        return item[this.getXProperty(breakpoint)];
    }

    public getValueY(breakpoint?: any) {
        const item = this.getItem();

        return item[this.getYProperty(breakpoint)];
    }

    public getValueW(breakpoint?: any) {
        const item = this.getItem();

        return item[this.getWProperty(breakpoint)] || 1;
    }

    public getValueH(breakpoint?: any) {
        const item = this.getItem();

        return item[this.getHProperty(breakpoint)] || 1;
    }

    public setValueX(value: number, breakpoint?: any) {
        const item = this.getItem();

        item[this.getXProperty(breakpoint)] = value;
    }

    public setValueY(value: number, breakpoint?: any) {
        const item = this.getItem();

        item[this.getYProperty(breakpoint)] = value;
    }

    public setValueW(value: number, breakpoint?: any) {
        const item = this.getItem();

        item[this.getWProperty(breakpoint)] = value;
    }

    public setValueH(value: number, breakpoint?: any) {
        const item = this.getItem();

        item[this.getHProperty(breakpoint)] = value;
    }

    public triggerChangeX(breakpoint?: any) {
    ...
    public triggerChangeY(breakpoint?: any) {
        const item = this.itemComponent;
        if (item) {
    ...
    public triggerChangeW(breakpoint?: any) {
        const item = this.itemComponent;
        if (item) {
    ...
    public triggerChangeH(breakpoint?: any) {
        const item = this.itemComponent;
        if (item) {
    ...
    public hasPositions(breakpoint?: any) {
