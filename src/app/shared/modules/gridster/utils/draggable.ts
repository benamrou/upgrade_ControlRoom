...
export class Draggable {
    ...
    private startScrollForWindow(event: any) {
        if (!this.config.scrollDirection || this.config.scrollDirection === 'vertical') {
    ...
    private getScrollContainer(node): HTMLElement | null {
    ...
    private startAutoScrolling(node: any, amount: any, direction: any) {
    ...
    private getScroll(scrollProp: any, offsetProp: any) {
    ...
    private fixProblemWithDnDForIE(element: Element) {
        if (this.isTouchDevice() && this.isIEorEdge() && (<HTMLElement>element).style) {
            (<HTMLElement>element).setAttribute('style','touch-action:none');
        }
    }
    ...
    private removeTouchActionNone(element: Element) {
        ...
        (<HTMLElement>element).setAttribute('style','touch-action:""');
    }
