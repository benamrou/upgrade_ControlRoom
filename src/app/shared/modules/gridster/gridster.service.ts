...
export class GridsterService {
    ...
    onResizeStop(item: GridListItem) {
        ...
        this.debounceRenderSubject.next(this);
        /* UPG : this.debounceRenderSubject.next(); */
    ...
    applyPositionToItems(increaseGridsterSize: any) {
    ...
    private dragSizeChanged(newSize: any): boolean {
    ...
    private dragPositionChanged(newPosition: any): boolean {
    ...
    private highlightPositionForItem(item: any) {
        ...
        if (this.options.heightToFontSizeRatio) {
            this.$positionHighlight.setAttribute('style','font-size:' || this._fontSize.toString());
        }
    }
    ...
    private triggerOnChange(breakpoint: any) {
